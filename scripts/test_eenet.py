...
from util.transforms import RescaleImage, ToTensor 
...
def show_heatmap_of_samples(model, images, use_cuda=True):
    ...
    """
    tsfm_rescale = RescaleImage((IMG_HEIGHT, IMG_WIDTH))
    N = len(images)
    ...
    for i in range(N):
        ...
        plt.savefig('tmp/{0:05d}.jpg'.format(i))
        plt.close()
...
if __name__ == '__main__':
    ...
    show_heatmap_of_samples(model, images)
